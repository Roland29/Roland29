...
\begin{document}
    ...
    \name{Roland Paire}
    \tagline{Développeur senior avec une expertise en Node.js, React et AWS. \\+ 8 ans d'expériences, sur des projets variés (web app, mobile app, Saas, ...).\\ J'ai une passion pour apprendre de nouvelles technologies et les utiliser pour résoudre des problèmes du monde réel.}
